...
impl PmixGeometry {
    ...
    pub fn fabric(&self) -> usize {
        // SAFETY: constructed objects are initialized by PMIx or `test_new`.
    ...
    pub fn coordinates(&self) -> Option<&[ffi::pmix_coord_t]> {
        // SAFETY: PMIx supplies the pointer and length; null means absent.
        unsafe {
    ...
    fn c_string(
        ...
        // SAFETY: the raw object is initialized and PMIx owns the string.
        unsafe {
